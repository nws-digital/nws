export const SOCIAL_LINKS = [
  {
    name: 'Twitter',
    url: 'https://x.com/nws_network',
  },
  {
    name: 'Facebook',
    url: 'https://www.facebook.com/p/NWS-61585008767062/',
  },
  {
    name: 'Instagram',
  ...
  {
    name: 'LinkedIn',
    url: 'https://www.linkedin.com/in/nwsnetwork',
  },
] as const

export const SOCIAL_ICONS: Record<string, {viewBox: string; path: string}> = {
  Twitter: {
    viewBox: '0 0 24 24',
