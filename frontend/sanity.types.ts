...
// Query: *[_type == "article" && category == "commentary"] | order(date desc)[$offset...$limit] {    _id,    title,    slug,    excerpt,    "contentPreview": array::join(string::split(pt::text(content), "")[0..200], ""),    date,    "author": author->{firstName, lastName, designation, picture}  }
