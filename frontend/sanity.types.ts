...
// Query: *[_type == "article" && category != "commentary"] | order(date desc)[0...6] {    _id,    title,    slug,    excerpt,    "contentPreview": array::join(string::split(pt::text(content), "")[0..200], ""),    date,    category,    coverImage,    "author": author->{firstName, lastName, designation, picture, bio}  }
